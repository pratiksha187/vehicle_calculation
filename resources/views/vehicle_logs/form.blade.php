@php
    $entries = old('entries', isset($log) && $log ? $log->dailyEntries->map(function($e){
        return [
            ...
            'driver_name' => $e->driver_name ?: 'Rohit',
        ...
        <tbody>
            @foreach($entries as $index => $entry)
                <tr>
                    ...
                    <td><input type="text" name="entries[{{ $index }}][driver_name]" class="form-control" value="{{ $entry['driver_name'] ?? 'Rohit' }}" list="driverNames"></td>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('addRow').addEventListener('click', function () {
        ...
        tr.innerHTML = `
            ...
            <td><input type="text" name="entries[${rowIndex}][driver_name]" class="form-control" value="Rohit" list="driverNames"></td>
