            ...
            <tbody>
                @forelse($logs as $key => $log)
                    <tr>
                        ...
                        <td>{{ number_format($log->driverPayments->sum('net_payment') ?: 20000, 2) }}</td>
                        ...
                        <td>
                            ...
                            <a href="{{ route('vehicle-logs.driver-details', $log->id) }}" class="btn btn-sm btn-secondary">Driver Details</a>
